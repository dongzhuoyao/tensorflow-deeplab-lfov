...
class DeepLabLFOVModel(object):
    ...
    def _create_network(self, input_batch, keep_prob):
        ...
        return stage0_feat, stage1_feat,stage2_feat
    ...
    def preds(self, input_batch):
        ...
        _,_, raw_output = self._create_network(tf.cast(input_batch, tf.float32), keep_prob=tf.constant(1.0))
    ...
    def loss(self, img_batch, label_batch,weight_decay = 0.05):
        ...
        raw_output, raw_output1,raw_output2 = self._create_network(tf.cast(img_batch, tf.float32),
